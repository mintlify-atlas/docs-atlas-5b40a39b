...
- [`scan_nodes_by_types`](/api/scanning/scan-nodes-by-types) - Find nodes by type to delete
- [`scan_text_nodes`](/api/scanning/scan-text-nodes) - Find text nodes to delete