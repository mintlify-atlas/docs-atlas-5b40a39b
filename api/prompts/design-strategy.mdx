...
- [create_frame](/api/creating-elements/create-frame)
- [create_text](/api/creating-elements/create-text)
- [get_document_info](/api/document-selection/get-document-info)
