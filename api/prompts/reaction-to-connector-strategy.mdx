...
- [get_reactions](/api/prototyping-connections/get-reactions)
- [set_default_connector](/api/prototyping-connections/set-default-connector)
- [create_connections](/api/prototyping-connections/create-connections)
