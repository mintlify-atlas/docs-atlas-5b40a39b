...
- [get_document_info](/api/document-selection/get-document-info) - First command after joining
- [get_selection](/api/document-selection/get-selection) - Check current selection
